    ...
    var e, t, n = {
        ...
        5083: (e,t,n)=>{
            ...
            const u = {
              ...
              , p = function(e, t) {
                var p, h;
                const f = Object.assign({}, null == (p = window) || null == (h = p.jwplayer) ? void 0 : h.defaults, t, e);
                !function(e) {
                ...
                const g = f.forceLocalizationDefaults ? u.language : (0,
                c.G3)()
                  , m = (0,
                c.tK)(f.intl);
                f.localization = (0,
                ...
                const b = f.autoPause;
                b && (y.autoPause.viewability = !("viewability"in b) || Boolean(b.viewability));
                const w = y.playbackRateControls;
                if (w) {
                    let e = y.playbackRates;
                    Array.isArray(w) && (e = w),
                    e = e.filter((e=>(0,
                    s.hj)(e) && e >= .25 && e <= 4)).map((e=>Math.round(100 * e) / 100)),
                ...
                const k = y.playlist;
                if (k)
                    Array.isArray(k.playlist) && (y.feedData = k,
                    y.playlist = k.playlist);
                else {
                    const e = (0,
                ...
                s.qh)(C) ? C : function(e) {
                    ...
                    return (0,
                    s.qh)(t) ? Math.max(t, 1) : u.bandwidthEstimate
                }(y.defaultBandwidthEstimate),
                y.bitrateSelection = (0,
                s.qh)(P) ? P : u.bitrateSelection,
                y.liveSyncDuration = d(y.liveSyncDuration),
                y.backgroundLoading = (0,
                s.jn)(y.backgroundLoading) ? y.backgroundLoading : a.Features.backgroundLoading,
                y
            }
        }
        ,
        ...
        623: (e,t,n)=>{
            ...
            const f = function() {
              ...
              , m = function(e) {
                ...
                return p.OS.tizen ? g() : t && r && i ? function() {
            ...
            const T = function(e) {
              ...
              , Z = e=>A(e) ? Promise.resolve() : P(e).then((()=>{
                ...
                return P(t = e).then((()=>{
                    ...
                    return "function" == typeof i ? i : o.Tr.html5 && "html5" === s ? o.Tr.html5 : n.load(s).catch((e=>{
                        throw (0,
                        d.l9)(e, d.y4)
                    }
                    ))
            ...
            Object.assign(te.prototype, {
                ...
                init(e, t) {
                    ...
                    this.setup.start(t).then((e=>{
                        ...
                        this.playerSetup(o, t, this.originalContainer, this._events, s, l);
                        const a = this._model;
                        return n.off("change:errorEvent", J),
                        a.on("change:errorEvent", J),
                        r.track(a),
                        this.updatePlaylist(a.get("playlist"), a.get("feedData")).catch((e=>{
                        ...
                        case "subtitle":
                            {
                                ...
                                (0,
                                i.Dc)(c, "lang").length > 0 && (e.label = s((0,
                                i.Dc)(c, "lang"))),
                                n.push(e);
                                break
                            }
            ...
            const u = function(e, t) {
                ...
                if (a.length) {
                    ...
                    for (let e = 0; e < a.length; e++) {
                        const t = a[e];
                        t.file.length > 0 && (t[n] = "true" === a[e][n],
                ...
                if (l.length) {
                    ...
                    for (let e = 0; e < l.length; e++) {
                        const t = l[e];
                        t.file && t.file.length > 0 && (t[n] = "true" === l[e][n],
                ...
                const e = Object.assign(this, a.ZP)
                  ...
                  , n = function(n) {
                    try {
                        ...
                        let s, a = null;
                        if (t) {
                            for (let e = 0; e < t.length && (a = t[e],
                            8 === a.nodeType); e++)
                                ;
                            if (a && "xml" === (0,
                            i.r1)(a) && (a = a.nextSibling),
                            a && "rss" === (0,
                            i.r1)(a)) {
                                const e = (0,
                                o.Z)(a);
            ...
            const c = (e,t)=>void 0 === e ? t : e
              ...
              , d = (e,t)=>{
                ...
                return (o || r).map((function(t) {
                    ...
                    return void 0 !== o && (t.withCredentials = o),
                    (0,
                    s.Z)(t)
                }
                )).filter(Boolean)
        ...
        6053: (e,t,n)=>{
            ...
            const o = function(e) {
                ...
                const n = /^[^/]+\/(?:x-)?([^/]+)$/
                  , o = t.type;
                if (n.test(o) && (t.mimeType = o,
                t.type = o.replace(n, "$1")),
                (0,
        ...
        1241: (e,t,n)=>{
            ...
            function d(e, t) {
                ...
                return (e.pluginLoader = e.pluginLoader || new o).load(t, c, n, e).then((t=>{
              ...
              , l = {
                ...
                sendMediaType(e) {
                    const {type: t, mimeType: n} = e[0]
                      , i = "aac" === t || "mp3" === t || "mpeg" === t || n && 0 === n.indexOf("audio/");
                    this.trigger(r.oZ, {
        ...
        1628: (e,t,n)=>{
            ...
            var r = n(8348);
            const i = e=>"hls" === e.type && r.OS.android ? !1 !== e.androidhls && (!r.Browser.firefox && parseFloat(r.OS.version.version || "0") >= 4.4) : null
        }
        ,
        12: (e,t,n)=>{
            "use strict";
        ...
        6593: (e,t,n)=>{
            ...
            const s = {
              ...
              , a = e=>{
                ...
                return null != l && l.length && (a = [a].concat(l.slice()).join("; ")),
                ...
                if ("XMLHttpRequest"in window) {
                    ...
                    p.onreadystatechange = (e=>function(t) {
                        ...
                        if (4 === n.readyState) {
                            ...
                            const r = n.status;
                            if (r >= 400)
                                return void l(e, o.ul, r < 600 ? r : 6);
                            if (200 === r)
                                return u(e)(t);
                            0 === r && (0,
        ...
        2268: (e,t,n)=>{
            ...
            const r = e=>null !== navigator.userAgent.match(e)
              , i = ()=>"MacIntel" === navigator.platform && navigator.maxTouchPoints > 1
              , o = ()=>r(/firefox\//i)
              , s = ()=>r(/iP(hone|od)/i)
              , a = ()=>r(/iPad/i) || i()
              , l = ()=>r(/Macintosh/i) && !i()
        ...
        2799: (e,t,n)=>{
            ...
            const c = (e,t)=>e.classList.contains(t)
              , u = e=>{
                ...
                return e.toLowerCase().indexOf("<!doctype") > -1 ? t.documentElement.innerHTML = e : t.body.innerHTML = e,
                t.body
            }
              , d = e=>{
              ...
              , h = e=>{
                ...
                for (let n = t.length; n--; ) {
                    const r = t[n].name;
                    if (/^on/.test(r) && e.removeAttribute(r),
                    /href/.test(r)) {
                        const i = t[n].value;
            ...
            i.HD)(e.className) ? e.className.split(" ") : []
              ...
              , T = e=>{
                ...
                return n.width || n.height || n.left || n.top ? (t.left = n.left + i,
                t.right = n.right + i,
                t.top = n.top + r,
                t.bottom = n.bottom + r,
        ...
        8518: (e,t,n)=>{
            ...
            y.mock_ = null;
            const v = ["ar", "da", "de", "el", "es", "fi", "fr", "he", "id", "it", "ja", "ko", "nb", "nl", "nn", "no", "oc", "pt", "ro", "ru", "sl", "sv", "th", "tr", "vi", "zh"]
            ...
            const k = (e,t,n)=>{
              ...
              , j = (e,t,n)=>Object.assign({}, (e=>{
                const {advertising: t, related: n, sharing: r, abouttext: i} = e
                  , o = Object.assign({}, e.localization);
                t && (o.advertising = o.advertising || {},
            ...
            r.qh)(e) ? e : "" === e ? 0 : e.lastIndexOf("%") > -1 ? e : parseInt(e.replace("px", ""), 10)
              , u = (e,t)=>{
                ...
                const i = Math.floor(e / 3600)
                  ...
                  , s = Math.floor(e % 60);
                return `${n + (i ? `${i}:` : "") + (o < 10 ? "0" : "") + o}:${s < 10 ? "0" : ""}${s}`
            }
              , d = e=>{
                if ((0,
                r.i2)(e) && (e = parseInt(e.toString(), 10)),
                ...
                const t = Math.floor(e / 3600)
                  ...
                  , i = Math.floor(e % 60);
                return (t ? t + (t >= 1 ? ` hour ${t > 1 ? "s" : ""}, ` : "") : "") + (n ? n + (n >= 1 ? ` minute ${n > 1 ? "s" : ""}, ` : "") : "") + i + (i >= 1 ? " second" + (i > 1 ? "s" : "") : "")
            }
        }
        ,
        1569: (e,t,n)=>{
              ...
              , l = function(e, t, n) {
                ...
                this.load = function() {
                    ...
                    r = new Promise(((r,i)=>{
                        ...
                        ;
                        const h = document.getElementsByTagName("head")[0] || document.documentElement;
            ...
            const b = (e,t,n)=>{
                const {el: r} = e
                  , i = ((e,t,n)=>{
                    ...
                    let s, {pointerType: a} = t;
                    i || o ? (s = null != i && i.length ? i[0] : o[0],
                    a = a || "touch") : (s = t,
                    a = a || "mouse");
              ...
              , E = e=>{
                ...
                j(e, h, "click", (n=>{
                    S(n) || Boolean(e.directSelect) && n.target !== t || ((0,
                    s.z)() - e.lastStart > 500 && !0 === e.clicking || (((e,t)=>{
        ...
        6042: (e,t,n)=>{
            ...
            const A = T.Date
              ...
              , J = X
              , Y = function(e) {
                return null == e ? 0 : e.length === Number(e.length) ? e.length : x(e).length
            }
              , ee = function(e, t) {
                let n;
                return function(...r) {
            ...
            const r = /^[^:/?#]+:?\/\/[^/?#]+/
              ...
              , a = function(e, t="{seek_to_second_number}") {
                if (!e)
                    return;
                const n = new URL(e);
                return n.searchParams.set("jw_start", t),
                n.toString()
            }
              , l = (e,t)=>{
                if (e)
        ...
        4225: (e,t,n)=>{
            ...
            function s(e, t) {
                const {message: n, code: s} = t
                  , a = r(e.get("id"), n, e.get("localization").errors.errorCode, s.toString())
                  , l = e.get("width")
                  , c = e.get("height")
                  , u = (0,
                i.az)(a);
        ...
        4671: (e,t,n)=>{
            ...
            const f = (e,t)=>{
              ...
              , g = ()=>{
                s.forEach((e=>{
                    const t = e.model;
                    if (t.get("audioMode") || t.get("isFloating") || !t.get("controls") || t.get("visibility") < .75)
                        return;
                    const n = t.get("state")
                      , r = (0,
                    o.UM)();
            ...
            const g = e=>"string" == typeof e && /^\/\/(?:content\.jwplatform|cdn\.jwplayer)\.com\//.test(e)
              ...
              , k = function(e, t) {
                ...
                const p = c.key || a.default.key
                  , v = new l.ZP(p)
                  , b = v.edition();
                if ("free" === v.edition() && (c = Object.assign({
                    skin: {
                        active: "#ff0046",
                        timeslider: {
                            progress: "none"
                ...
                o.ei)(c, ["analytics", "aspectratio", "base", "file", "height", "playlist", "sources", "timeSlider", "width"]))),
                c.key = p,
                c.edition = b,
                c.error = v.error(),
                ...
                k = c.playlist,
                (0,
                o.HD)(k) && k.indexOf(u) > -1 && (c.playlist = ((e,t)=>{
                    var n;
                    ...
                    const s = d(e, 'meta[property="og:description"]') || d(e, 'meta[name="description"]');
                    return s && (o += `&page_description=${encodeURIComponent(s)}`),
                    t.replace(u, o)
                }
                )(document, c.playlist),
                c.contextual = !0),
                ...
                return c.__abSendDomainToFeeds && (C = c.playlist,
                /\.jwplatform.com|\.jwplayer.com/.test(C)) && (c.playlist = (j = c.playlist) + `${-1 !== j.indexOf("?") ? "&" : "?"}page_domain=${encodeURIComponent((0,
                f.X)())}`),
                c
            }
        }
        ...
        576: (e,t,n)=>{
            ...
            const S = e=>{
              ...
              , x = function(e) {
                let t, n;
                if (e ? "string" == typeof e ? (t = S(e),
                t || (n = document.getElementById(e))) : "number" == typeof e ? t = s.Z[e] : e.nodeType && (n = e,
            ...
            ;
            {
                ...
                r.B.push({
                    ...
                    supports(e) {
                        ...
                        a.d3)(e.drm))
                            return !1;
                        if (!window.HTMLVideoElement || !window.MediaSource)
                            return !1;
                        return c(e.mediaTypes) && ("hls" === e.type || "dash" === e.type || "mpd" === e.type || (e.file || "").indexOf("mpd-time-csf") > -1)
                    }
                }),
                r.B.unshift({
                    name: "hlsjs",
                    supports: e=>(e=>{
                        ...
                        if (!t && !n)
                            return !1;
                        const r = Boolean(null == l.Z || null == l.Z.canPlayType ? void 0 : l.Z.canPlayType("application/vnd.apple.mpegURL"))
                          , o = !r || i.OS.android || i.OS.tizen
                          , s = i.Browser.safari && !r
                          , a = i.OS.android && !1 === e.hlsjsdefault
                          , u = i.Browser.safari && Boolean(e.safarihlsjs);
                        return c(e.mediaTypes || ['video/mp4;codecs="avc1.4d400d,mp4a.40.2"']) && (o || u || s) && !a
                    }
                    )(e)
                })
            }
            ...
            const i = e=>unescape(encodeURIComponent(e))
              ...
              , a = function(e, t) {
                ...
                r.t)(e))
                  ...
                  , l = n.length
                  , c = 2654435769;
                let u, d, p = n[l - 1], h = n[0], f = Math.floor(6 + 52 / l) * c;
                for (; f; ) {
                    d = f >>> 2 & 3;
                    for (let e = l - 1; e >= 0; e--)
                        p = n[e > 0 ? e - 1 : l - 1],
                        u = (p >>> 5 ^ h << 2) + (h >>> 3 ^ p << 4) ^ (f ^ h) + (a[3 & e ^ d] ^ p),
                        h = n[e] -= u;
                    f -= c
                }
                return (e=>{
